...
public class HtmlFileWriter {
    ...
    public static void main(String[] args) {
        ...
        String postDate = "September 25 2024";
        String readTime = "8";
        String postTitle = "Adding a Search Bar to Your Website";
        String featuredImage = "searchBar1.jpg";
        String featuredImage2 = "searchBar2.jpg";
        String postContent = "A guide on how to add your own custom search bar to any website.";
        ...
        String keywords = "blog, computer, science, computer science, code, coding, programming, programmer, developer, developing, devlog, tutorial, help, devlog, graduate, graduation, " +
                            ...
                            "search, bar, search bar, search feature, fetch, api, json, find, locate, query, tags, keywords, render, results, search results," + 
